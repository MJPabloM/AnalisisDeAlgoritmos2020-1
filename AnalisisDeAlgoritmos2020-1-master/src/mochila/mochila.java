...
public class mochila {
    ...
    public mochila(ArrayList<articulos> items, int _W) {
    ...
    public ArrayList<articulos> getItemsSolucion() {
        return itemsSolucion;
    }

    public void setItemsSolucion(ArrayList<articulos> itemsSolucion) {
